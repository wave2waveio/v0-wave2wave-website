      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 py-24 px-4 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <img
                src="images/design-mode/Hero-EVO-2RU-Evo-Switch-1.png"
                alt="EVO™ & EXO™ High-Density Patch Panel Platforms"
                className="w-full h-auto rounded-lg shadow-2xl"
              />
              <div className="grid grid-cols-2 gap-4">
                <img
                  src="images/design-mode/Hero-EVO-2RU-Evo-Switch-2.png"
                  alt="EVO™ Platform"
                  className="w-full h-32 object-cover rounded-lg shadow-xl"
                />
                <img
                  src="images/design-mode/EVO-2RU-Filled-Front-Panel-highlights2-300x172.jpg"
                  alt="EXO™ Platform"
                  className="w-full h-32 object-cover rounded-lg shadow-xl"
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="images/design-mode/EVO_6xMTP_Feed-through.png"
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="images/design-mode/EVO_12xMTP_Feed-through.png"
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="images/design-mode/EVO_Cassettes_Stacked.png"
                  alt="EVO MTP"
                  className="w-full h-32 object-contain mb-4 rounded"
                />
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="images/design-mode/EVO_LC_Cassette.png"
                  alt="EVO LC"
                  className="w-full h-32 object-contain mb-4 rounded"
                />
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="images/design-mode/EVO-LC.CASSCFT1.png"
                  alt="EVO SC"
                  className="w-full h-32 object-contain mb-4 rounded"
                />
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border border-gray-200">
              <CardHeader>
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/EVO-LC-Feedthrough%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29%283%29%281%29-IxXgFjtoBblqvkRiXDRnPTAwlgxOXH.png"
            ...
            <div className="text-center space-y-4">
              <a href="https://youtu.be/m4jIYh3ug9g" target="_blank" rel="noopener noreferrer" className="block">
                <div className="relative group cursor-pointer">
                  <img
                    src="images/design-model/EVO-2RU-Filled-Front-Panel-highlights2-300x172.jpg"
