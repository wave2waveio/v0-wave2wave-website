...
// Legacy GET endpoint for email campaign tracking (redirects to survey)
...
// New POST endpoint for full survey submission
export async function POST(request: NextRequest) {
  console.log('=== API /nps-track POST endpoint called ===');
  ...
  try {
    ...
    console.log('=== API /nps-track completed successfully ===');
    return NextResponse.json({ success: true }, { status: 200 });
  } catch (error) {
    console.error('=== API /nps-track ERROR ===');
