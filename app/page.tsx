      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">Comprehensive infrastructure solutions from design to deployment</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-4">
                ...
                />
                <CardTitle className="text-2xl">Structured Cabling & Hardware</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">
                  Custom copper and fiber cabling systems, PDUs, racks, and accessories engineered for your specific
                  requirements.
                </CardDescription>
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>• Copper & Fiber Optic Systems (w-Ignite brand)</li>
                  <li>• Patch Panels, Racks, Enclosures</li>
                  <li>• PDUs & Cable Management</li>
                  <li>• Connectors, Jacks & Accessories</li>
                </ul>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-4">
                <Image
                  ...
                  className="w-full h-48 object-cover rounded-lg mb-4"
                />
                <CardTitle className="text-2xl">Advanced Kitting & Logistics</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">
                  Precision-organized hardware and cabling kits by rack and server to accelerate installation and reduce
                  errors.
                </CardDescription>
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>• Rack-by-rack organization</li>
                  <li>• Server-specific kitting</li>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-4">
                <Image
                  ...
                  className="w-full h-48 object-cover rounded-lg mb-4"
                />
                <CardTitle className="text-2xl">DCIM & Digital Twin Services</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">
                  Comprehensive DCIM consulting, digital twin design, and managed services for ongoing infrastructure
                  optimization.
                </CardDescription>
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>• DCIM Consulting & Design</li>
                  <li>• Digital Twin Development</li>
                  <li>• Managed DCIM Services</li>
